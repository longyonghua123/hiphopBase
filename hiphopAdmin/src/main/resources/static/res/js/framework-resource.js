...
$(function() {
    ...
    var k = a.split("/");
    var d = getPosition("skin", k) + 1;
    skinName = k[d];
    if (broswerFlag == "IE6" || broswerFlag == "IE7") {
        if ($(window.top.document.getElementById("skin")).attr("href") == "") {} else {
            $.ajax({
                url: prePath + "css"  + "/import_skin.css",
                error: function() {
                    alert("无法通过路径：" + prePath + "css" + "/import_skin.css加载CSS，请检查prePath设置的是否正确。详情请参照“使用帮助>>内页结构及注意事项”")
                }
            })
        }
    } else {
    ...
    $("#skin").attr("href", prePath + "css" + "/import_skin.css");
    try {
            ...
            if (a(this).attr("useMultColor") == "true") {
                if (a(this).attr("useCheckBox") == "false") {
                    ...
                    if (a(this).find("th").length > 0) {
                        var b = a("<img src=" + prePath + 'images/icons/checkAllOff.gif title="点击全选" class="hand"></span>');
                        ...
                        if (a(this).attr("headFixMode") == "true") {
                            b.toggle(function() {
                                ...
                                a(this).attr("src", prePath + "images/icons/checkAllOn.gif");
                            ...
                            function() {
                                ...
                                a(this).attr("src", prePath + "images/icons/checkAllOff.gif");
